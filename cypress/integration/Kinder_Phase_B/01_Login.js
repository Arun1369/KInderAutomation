...
describe('Login', () => {
    ...
    //Create the test data and save in example.js file 
    ...
    it('Seed the test data', () => {
        cy.writeFile("cypress/fixtures/example.json", {
            ...
            agencyEmailID2: faker.internet.email(),
            ...
            alergypublished: faker.name.firstName(),
            alergyUnpublished: faker.name.firstName()
        })
